...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'wasabi' => [
            'driver' => 's3',
            'key' => env('WASABI_ACCESS_KEY_ID', env('AWS_ACCESS_KEY_ID')),
            'secret' => env('WASABI_SECRET_ACCESS_KEY', env('AWS_SECRET_ACCESS_KEY')),
            'region' => env('WASABI_REGION', env('AWS_DEFAULT_REGION', 'us-east-1')),
